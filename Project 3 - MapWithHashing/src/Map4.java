...
public class Map4<K, V> extends MapSecondary<K, V> {
     ...
     * Buckets for hashing.
     */
    private Array1L<Map<K, V>> hashTable;
    ...
    public final Pair<K, V> removeAny() {
        ...
        int i = 0;
        do {
            empty = this.hashTable.entry(i).equals(new Map2<K, V>());
            i++;
        } while (empty);
        i--;
        Pair<K, V> pair = this.hashTable.entry(i).removeAny();
        this.size--;
        return pair;
    }
    ...
    private final class Map4Iterator implements Iterator<Pair<K, V>> {
        ...
        Map4Iterator() {
            ...
            this.bucketIterator = Map4.this.hashTable.entry(this.currentBucket)
                    .iterator();
        }
