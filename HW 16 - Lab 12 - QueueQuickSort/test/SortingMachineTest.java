...
public abstract class SortingMachineTest {
    ...
    public final void testAddNonEmpty() {
        SortingMachine<String> m = this.createFromArgsTest(ORDER, true, "Juck",
                "Gang", "Pom");
        SortingMachine<String> mExpected = this.createFromArgsRef(ORDER, true,
                "Juck", "Gang", "Pom", "Kik");
        m.add("Kik");
    ...
    public final void testRemoveFirstLeavingEmpty() {
        ...
        assertEquals("Juck", str);
        assertEquals(mExpected, m);
    }

    @Test
    public final void testRemoveFirstNotLeavingEmpty() {
        SortingMachine<String> m = this.createFromArgsTest(ORDER, false, "Juck",
                "Gang", "Pom", "Kik");
        SortingMachine<String> mExpected = this.createFromArgsRef(ORDER, false,
                "Juck", "Pom", "Kik");
        String str = m.removeFirst();
        assertEquals("Gang", str);
        assertEquals(mExpected, m);
    }
