...
public abstract class ListTest {
    ...
    @Test
    public final void testRetreatFromRightEmpty() {
        List<String> list1 = this.createFromArgsTest(4, "James", "Arj", "Joe",
                "Billy");
        List<String> list2 = this.createFromArgsTest(3, "James", "Arj", "Joe",
                "Billy");
        list1.retreat();
    ...
    @Test
    public final void testRetreatLeavingLeftEmpty() {
        List<String> list1 = this.createFromArgsTest(1, "James", "Arj", "Joe",
                "Billy");
        List<String> list2 = this.createFromArgsTest(0, "James", "Arj", "Joe",
                "Billy");
        list1.retreat();
        assertEquals(list1, list2);
    }
    ...
    @Test
    public final void testRetreatNormal() {
        List<String> list1 = this.createFromArgsTest(2, "James", "Arj", "Joe",
                "Billy");
        List<String> list2 = this.createFromArgsTest(1, "James", "Arj", "Joe",
                "Billy");
        list1.retreat();
        assertEquals(list1, list2);
    }
